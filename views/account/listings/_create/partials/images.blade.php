    <div class="card mb-4  border-0 bord-rad-5 gray-background">
      <h5 class="card-header gray-background border-0 bord-rad-5 font-montserrat gray-text-color mt-2">Images</h5>
      <div class="card-body">
    ...
    <script>
      $('#fine-uploader-gallery').fineUploader({
        ...
        request: {
          endpoint: '{{route('account.listings.create.upload', $listing)}}',
          customHeaders: {
            'X-CSRF-TOKEN': $('meta[name="token"]').attr('content')
          }
        },
        session: {
          endpoint: '{{route('account.listings.create.session', $listing)}}',
          customHeaders: {
            'X-CSRF-TOKEN': $('meta[name="token"]').attr('content')
          }
        },
        ...
        deleteFile: {
          enabled: true,
          forceConfirm: true,
          endpoint: '{{route('account.listings.create.delete-image', $listing)}}',
          customHeaders: {
            'X-CSRF-TOKEN': $('meta[name="token"]').attr('content')
          }
        },
