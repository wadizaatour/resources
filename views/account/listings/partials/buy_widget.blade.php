...
@foreach($listing->variant_options as $variation => $name)
              <div class="row mt-3">
                ...
                <div class="col-sm-12">
                  <select name="variant[{{ $name }}]" class="form-control form-control-sm" required="require">
...
@if($listing->stock > 1)
              <div class="row mt-3">
                ...
                <div class="col-sm-4">
                  <select name="quantity" require="required" class="form-control form-control-sm">
                    <option value=""></option>
                  </select> {{-- todo: array_combine(range(1, $listing->stock), range(1, $listing->stock)) --}}
                </div>
              </div>
@else
              <input type="hiddden" name="quantity" value="1" />
@endif

@if(count($listing->shipping_options) > 0)
...
@if(count($listing->additional_options) > 0)
              <div class="row mt-3 mb-3">
                <div class="col-sm-12">
