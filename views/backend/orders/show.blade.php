...
@section('content')
    <a href="{{ route('backend.orders.index') }}" class="mb-1"><i class="fa fa-angle-left" aria-hidden="true"></i> back</a>
            ...
            <table class="table table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$order->listing->user->name}} ({{$order->listing->user->email}}) @if($order->paymentGateway)- {{$order->payment_gateway->gateway_id}}@endif</td>
                    </tr>
                    <tr>
