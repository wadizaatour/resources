...
@section('content')
    <div class="container">
      <a href="{{ route('backend.pricing-models.index', [], false)}}" class="mb-1"><i class="fa fa-angle-left" aria-hidden="true"></i> back</a>
      <div class="row mb-3">
        <div class="col-sm-8">
...
@if(!$pricing_model->exists)
              {!! Form::model($pricing_model, ['route' => ['backend.pricing-models.store', $pricing_model], 'method' => 'post']) !!}
@else
              {!! Form::model($pricing_model, ['route' => ['backend.pricing-models.update', $pricing_model], 'method' => 'put']) !!}
@endif
