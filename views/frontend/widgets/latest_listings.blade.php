<div class="row  mt-3">
  ...
  <div class="col-3">
    <a href="{{-- route(setting('marketplace_index')) --}}" class="btn btn-secondary btn-sm float-right">{{ __('VIEW ALL') }} <i class="mdi mdi-chevron-right"></i></a>
  </div>
</div>
  ...
  <div class="col-lg-{{ round(12/$config['limit'], 0, 1) }} col-6 col-sm-3 mb-3">
    <div class="card ">
      <div style="position:relative">
        <a href="{{ $item->url }}" class="roundeds border-top image-wrappers mb-4 text-center">
