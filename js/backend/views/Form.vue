        ...
        <b-col xl="6">
          <b-card>
            <h3 class="card-title" slot="header">
              {{
                isNew
                  ? $t('labels.backend.forms.titles.create')
                  : $t('labels.backend.forms.titles.edit')
              }}
            </h3>
            <b-form-group
            ...
            <b-form-group
              ...
              :description="$t('labels.backend.forms.descriptions.recipients')"
              horizontal
              :label-cols="3"
            ...
            <b-form-group
              ...
              label-for="message"
              :description="$t('labels.backend.forms.descriptions.message')"
              horizontal
              :label-cols="3"
            ...
            <b-row slot="footer">
              <b-col md>
                <b-button to="/forms" exact variant="danger" size="sm">
                  {{ $t('buttons.back') }}
                </b-button>
              </b-col>
              <b-col md>
                <b-button
                  ...
                  class="float-right"
                  :disabled="pending"
                  v-if="isNew || this.$app.user.can('edit forms')"
                >
...
export default {
  ...
  async created() {
    ...
    let { data } = await axios.get(
      this.$app.route(`backend.${this.modelName}s.get_form_types`)
    )
