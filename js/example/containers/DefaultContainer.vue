<template>
  <div class="app">
    <AppHeader fixed>
      ...
      <b-navbar-nav class="ml-auto">
        <b-nav-item class="d-md-down-none">
          <DefaultHeaderDropdownNotif></DefaultHeaderDropdownNotif>
        </b-nav-item>
        <b-nav-item class="d-md-down-none">
          <DefaultHeaderDropdownTasks></DefaultHeaderDropdownTasks>
        </b-nav-item>
        <b-nav-item class="d-md-down-none">
          <DefaultHeaderDropdownMssgs></DefaultHeaderDropdownMssgs>
        </b-nav-item>
        <b-nav-item class="d-md-down-none">
          <DefaultHeaderDropdown></DefaultHeaderDropdown>
        </b-nav-item>
    ...
    <div class="app-body">
      ...
      <AppAside fixed><DefaultAside></DefaultAside></AppAside>
    </div>
    <TheFooter>
      <div class="ml-auto">
        <span class="ml-1">&copy; 2019 <a href="/">Company</a>.</span>
      </div>
    </TheFooter>
  </div>
</template>
